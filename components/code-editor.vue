...
<template>
  <div class="h-screen flex flex-col mt-8 lg:mt-0">
    ...
    <button type="button" class="absolute lg:right-2 lg:left-auto left-2 lg:top-4 bottom-28 lg:bottom-auto z-20 text-white bg-persian-green hover:bg-sandy-brown focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-1 text-center inline-flex items-center mr-2 " @click="toggleHelp">
